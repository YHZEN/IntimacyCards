...
本项目采用 **[非商业使用许可](LICENSE)**（IntimacyCards Non-Commercial Use License）。

| 允许 | 禁止（未经书面授权） |
|------|----------------------|
| 个人 / 情侣私人免费使用 | 收费下载、订阅、内购、广告变现 |
| 学习、阅读、修改源码（非商用） | 上架应用商店、小程序等营利渠道 |
| 非商用分享（须保留协议与署名） | 出售、出租、授权给企业或第三方 |
| | 以本项目名义做商业推广 |
...
- 使用与分发须遵守 [LICENSE](./LICENSE)：**允许非商业私人使用，禁止未经授权的商业使用**
